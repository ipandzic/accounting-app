...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='transaction',
            name='invoice_amount',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='HRK', max_digits=8),
        ),
        migrations.AlterField(
            model_name='transaction',
            name='start_date',
